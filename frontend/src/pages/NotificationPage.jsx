...
const NotificationPage = () => {
  ...
  const { mutate: acceptRequestMutation, isPending } = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["users"] }); // Also refresh recommendations
    },
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            className={`btn btn-sm transition-all ${
                              isPending ? "btn-disabled loading" : "btn-primary hover:btn-primary-focus"
                            }`}
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm my-1">
                              {notification.sender?.fullName || 'Someone'} accepted your friend request
                            </p>
