...
export async function getRecommendedUsers(req, res) {
  try{
    ...
    const currentUser = req.user; // Fetch the current user from the request
    const recommendedUsers = await User.find({
      $and:[
        {_id: {$ne: currentUserId}}, // Exclude the current user (myself)
...
export async function deleteFriendRequest(req, res) {
  try {
    ...
    await FriendRequest.findByIdAndDelete(userid);
